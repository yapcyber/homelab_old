...
> entreprise est à collecter côté alternance).
...
| Dette | Statut | Détail |
|---|---|---|
| **1 · Backup hors-site** | ✅ Faite et dépassée | Restic → Drive + USB LUKS (3-2-1-1). Reste à rassembler les captures. |
| **2 · Test restauration** | ✅ Faite | 22 juil. : snapshot restauré depuis le Drive, dumps intègres, `.enc` déchiffrés. Reste le PV. |
| **3 · Bascule HA** | 🔓 Débloquée | Produisible en arrêtant un nœud ≠ pve1 (le NFS survit). À faire avec pve4 + Pi. |
| **4 · Débits réseau** | ◑ À moitié | iperf3 1G faisable ; 10G bloqué (module SFP+ Cisco absent). |
